<template>
  <div className="side-panel">
    <div className="logo">
      <img :src="require('../assets/img/reactlogo.png')" alt="Logo" /> USER
      DASHBOARD
    </div>
...
.side-panel {
  background-image: url("../assets/img/user-background-03.jpg");
...
.logo {
  ...
  font-size: $font-l;
  border-bottom: $border-thickness solid $color-01;
